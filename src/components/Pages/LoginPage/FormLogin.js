...
function FormLogin() {
  ...
  const { setToken, setUserInfo } = authStore.getState();
    ...
    <div className={cx("body")}>
      <div className={cx("form-login")}>
        ...
        >
                  ...
                  if (value) {
                    if (value.trim() != "" && !value.includes(" ")) {
                      ...
                      return Promise.reject(
                        new Error("Tên tài khoản không hợp lệ")
                      );
                    }
                  }
                  return Promise.reject(
                    new Error("Tên tài khoản không được để trống")
                  );
                },
              }),
            ]}
          ...
          <Form.Item className={cx("form-submit")}>
            <button className={cx("btn-login")} size="large" role="button">
              Đăng nhập
            </button>
          </Form.Item>
        </Form>
